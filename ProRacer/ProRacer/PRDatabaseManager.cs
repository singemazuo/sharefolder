...
namespace ProRacer
{
    ...
    public class PRDatabaseManager
    {
        ...
        {
            SqlCommand cmmd = new SqlCommand("SELECT Sponsor.SponsorId,Participant AS FKSponsorId,SponsorName,LastName + ',' + FirstName AS FullName FROM Sponsor INNER JOIN Participant ON Sponsor.SponsorId = Participant.SponsorId", conn);
